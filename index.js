...
app.get('/about/press', (req, res) => {res.sendFile('home/press/index.html', {root: path.join(__dirname, 'public')});});
app.get('/about/branding', (req, res) => {res.sendFile('home/branding/index.html', {root: path.join(__dirname, 'public')});});
app.get('/about/acknowledgements', (req, res) => {res.sendFile('home/acknowledgements/index.html', {root: path.join(__dirname, 'public')});});
